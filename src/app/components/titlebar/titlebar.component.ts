...
export class TitlebarComponent {
  ...
  goToSignMessage() {
    this.router.navigate(['/metrix/signmessage/0']);
  }

  goToVerifyMessage() {
    this.router.navigate(['/metrix/signmessage/1']);
  }

  goToOptions() {
    this.router.navigate(['/metrix/options']);
  }
  ...
  goToInformation() {
    this.router.navigate(['/metrix/tools/0']);
  }

  goToDebugConsole() {
    this.router.navigate(['/metrix/tools/1']);
  }

  goToPeersList() {
    this.router.navigate(['/metrix/tools/2']);
  }
  ...
  goToAboutCore() {
    this.router.navigate(['/metrix/about/0']);
  }

  goToAboutAltitude() {
    this.router.navigate(['/metrix/about/1']);
  }
  ...
  openIssues() {
    let data = {
      core: this.wallet.networkInfo.version,
      connections: this.wallet.networkInfo.connections,
